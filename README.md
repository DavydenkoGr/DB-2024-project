...
#### [Запрос 1](scripts/requests/request1.sql)

Вывести всех учеников, которые когда-либо учились в 1 классе.

#### [Запрос 2](scripts/requests/request2.sql)

Найти средний балл по математике в 1 классе.

#### [Запрос 3](scripts/requests/request3.sql)

Вывести топ 5 учителей в порядке количества выставленных домашних заданий.

#### [Запрос 4](scripts/requests/request4.sql)

Найти все дз по предмету математика для 1А класса на 1 января 2024. Указать время занятий,
к которым должно быть выполнено дз.

#### [Запрос 5](scripts/requests/request5.sql)

Найти количество учеников по каждому классу.

#### [Запрос 6](scripts/requests/request6.sql)

Найти всех учеников, которые поступили в школу в 10 классе.

#### [Запрос 7](scripts/requests/request7.sql)

Найти всех учеников, которые меняли класс по параллели в течении 2020 учебного года.

#### [Запрос 8](scripts/requests/request8.sql)

Найти средний балл ученика с student_id=4 за второе полугодие 2024 года по всем предметам.

#### [Запрос 9](scripts/requests/request9.sql)

Вывести средний балл за второе полугодие 2024 года по всем классам. Упорядочить по возрастанию балла.

#### [Запрос 10](scripts/requests/request10.sql)

Найти всех должников по предмету география у преподавателя с teacher_id=8. Вывести информацию о задании и ученике.
